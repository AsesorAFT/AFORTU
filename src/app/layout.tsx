  ...
  return (
    <html lang="es" suppressHydrationWarning>
      ...
      <body className="font-body">
        ...
        <header className="flex h-16 items-center px-4 lg:px-6 bg-white/90 shadow fixed top-0 w-full z-50 border-b border-[#f7c873]/30">
          <Link href="/" className="flex items-center gap-2 font-semibold">
            <Image
              ...
              priority
            />
            <span className="font-bold text-xl text-[#0a1931]">AFORTU</span>
          </Link>
        </header>
